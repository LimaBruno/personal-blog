...
const ContactForm = () => {
  ...
  const onSubmit = (data, e) => {
	...
	.catch((error) => {
	  ...
	  console.log(error) //Show me the error in console log
	})
  }
	return (
    <ContactWrapper>
	  ...
	  <ContactFormMain onSubmit={handleSubmit(onSubmit)} 
		 name="contact"
		 method="post"
	  ...
	  />
	  {/*Show me the error on the interface */}
